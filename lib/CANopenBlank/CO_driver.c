...
#define CO_DRIVER_CO_CAN_ERRTX_PDO_LATE  0x0080 /**< 0x0080, TPDO is outside sync window */

#define CO_DRIVER_CO_CAN_ERRRX_WARNING  0x0100  /**< 0x0100, CAN receiver warning */
