...
typedef app_signal_t (*actor_worker_callback_t)(void *object, app_event_t *event, actor_worker_t *worker, app_thread_t *thread);
...
typedef actor_worker_callback_t (*actor_on_worker_assignment_t)(void *object, app_thread_t *thread);

typedef app_signal_t (*app_method_t)(void *object);
typedef void (*app_procedure_t)(void *object);
