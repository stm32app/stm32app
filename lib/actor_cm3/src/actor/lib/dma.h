...
#else
#define dma_set_read_from_peripheral(unit, stream) \
  dma_set_transfer_mode(unit, stream, DMA_SxCR_DIR_PERIPHERAL_TO_MEM)
#define dma_set_read_from_memory(unit, stream) \
  dma_set_transfer_mode(unit, stream, DMA_SxCR_DIR_MEM_TO_PERIPHERAL)
#endif
