...
} transport_i2c_message_argument_t;


void *i2c_pack_message_argument(uint8_t device_address, uint16_t memory_address);
transport_i2c_message_argument_t *i2c_unpack_message_argument(void **argument);

extern actor_interface_t transport_i2c_class;
