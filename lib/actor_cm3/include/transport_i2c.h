...
static inline void transport_i2c_set_phase(transport_i2c_t *i2c, uint8_t value) { 
    actor_set_property_numeric(i2c->actor, TRANSPORT_I2C_PHASE, (uint32_t)(value), sizeof(uint8_t));
}
static inline uint8_t transport_i2c_get_phase(transport_i2c_t *i2c) {
    return *((uint8_t *) actor_get_property_pointer(i2c->actor, TRANSPORT_I2C_PHASE));
}
/* 0x62XX15: null */
static inline void transport_i2c_set_slave_address(transport_i2c_t *i2c, uint8_t value) { 
    actor_set_property_numeric(i2c->actor, TRANSPORT_I2C_SLAVE_ADDRESS, (uint32_t)(value), sizeof(uint8_t));
}
static inline uint8_t transport_i2c_get_slave_address(transport_i2c_t *i2c) {
    return *((uint8_t *) actor_get_property_pointer(i2c->actor, TRANSPORT_I2C_SLAVE_ADDRESS));
}
