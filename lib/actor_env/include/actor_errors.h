...
typedef enum {
    ...
    APP_ERROR_GENERIC = 0x1000U,
    /** 0x20xx, Current */
    APP_ERROR_CURRENT = 0x2000U,
    /** 0x21xx, Current, device input side */
    APP_ERROR_CURRENT_INPUT = 0x2100U,
    /** 0x22xx, Current inside the device */
    APP_ERROR_CURRENT_INSIDE = 0x2200U,
    /** 0x23xx, Current, device output side */
    APP_ERROR_CURRENT_OUTPUT = 0x2300U,
    /** 0x30xx, Voltage */
    APP_ERROR_VOLTAGE = 0x3000U,
    /** 0x31xx, Mains Voltage */
    APP_ERROR_VOLTAGE_MAINS = 0x3100U,
    /** 0x32xx, Voltage inside the device */
    APP_ERROR_VOLTAGE_INSIDE = 0x3200U,
    /** 0x33xx, Output Voltage */
    APP_ERROR_VOLTAGE_OUTPUT = 0x3300U,
    /** 0x40xx, Temperature */
    APP_ERROR_TEMPERATURE = 0x4000U,
    /** 0x41xx, Ambient Temperature */
    APP_ERROR_TEMP_AMBIENT = 0x4100U,
    /** 0x42xx, Device Temperature */
    APP_ERROR_TEMP_DEVICE = 0x4200U,
    /** 0x50xx, Device Hardware */
    APP_ERROR_HARDWARE = 0x5000U,
    /** 0x60xx, Device Software */
    APP_ERROR_SOFTWARE_DEVICE = 0x6000U,
    /** 0x61xx, Internal Software */
    APP_ERROR_SOFTWARE_INTERNAL = 0x6100U,
    /** 0x62xx, User Software */
    APP_ERROR_SOFTWARE_USER = 0x6200U,
    /** 0x63xx, Data Set */
    APP_ERROR_DATA_SET = 0x6300U,
    /** 0x70xx, Additional Modules */
    APP_ERROR_ADDITIONAL_MODUL = 0x7000U,
    /** 0x80xx, Monitoring */
    APP_ERROR_MONITORING = 0x8000U,
    /** 0x81xx, Communication */
    APP_ERROR_COMMUNICATION = 0x8100U,
    /** 0x8110, CAN Overrun (Objects lost) */
    APP_ERROR_CAN_OVERRUN = 0x8110U,
    /** 0x8120, CAN in Error Passive Mode */
    APP_ERROR_CAN_PASSIVE = 0x8120U,
    /** 0x8130, Life Guard Error or Heartbeat Error */
    APP_ERROR_HEARTBEAT = 0x8130U,
    /** 0x8140, recovered from bus off */
    APP_ERROR_BUS_OFF_RECOVERED = 0x8140U,
    /** 0x8150, CAN-ID collision */
    APP_ERROR_CAN_ID_COLLISION = 0x8150U,
    /** 0x82xx, Protocol Error */
    APP_ERROR_PROTOCOL_ERROR = 0x8200U,
    /** 0x8210, PDO not processed due to length error */
    APP_ERROR_PDO_LENGTH = 0x8210U,
    /** 0x8220, PDO length exceeded */
    APP_ERROR_PDO_LENGTH_EXC = 0x8220U,
    /** 0x8230, DAM MPDO not processed, destination object not available */
    APP_ERROR_DAM_MPDO = 0x8230U,
    /** 0x8240, Unexpected SYNC data length */
    APP_ERROR_SYNC_DATA_LENGTH = 0x8240U,
    /** 0x8250, RPDO timeout */
    APP_ERROR_RPDO_TIMEOUT = 0x8250U,
    /** 0x90xx, External Error */
    APP_ERROR_EXTERNAL_ERROR = 0x9000U,
    /** 0xF0xx, Additional Functions */
    APP_ERROR_ADDITIONAL_FUNC = 0xF000U,
    /** 0xFFxx, Device specific */
    APP_ERROR_DEVICE_SPECIFIC = 0xFF00U,

    /** 0x2310, DS401, Current at outputs too high (overload) */
    APP_ERROR401_OUT_CUR_HI = 0x2310U,
    /** 0x2320, DS401, Short circuit at outputs */
    APP_ERROR401_OUT_SHORTED = 0x2320U,
    /** 0x2330, DS401, Load dump at outputs */
    APP_ERROR401_OUT_LOAD_DUMP = 0x2330U,
    /** 0x3110, DS401, Input voltage too high */
    APP_ERROR401_IN_VOLT_HI = 0x3110U,
    /** 0x3120, DS401, Input voltage too low */
    APP_ERROR401_IN_VOLT_LOW = 0x3120U,
    /** 0x3210, DS401, Internal voltage too high */
    APP_ERROR401_INTERN_VOLT_HI = 0x3210U,
    /** 0x3220, DS401, Internal voltage too low */
    APP_ERROR401_INTERN_VOLT_LO = 0x3220U,
    /** 0x3310, DS401, Output voltage too high */
    APP_ERROR401_OUT_VOLT_HIGH = 0x3310U,
    /** 0x3320, DS401, Output voltage too low */
    APP_ERROR401_OUT_VOLT_LOW = 0x3320U,
} APP_ERROR_errorCode_t;
 ...
 * sets specific bit in the _errorStatusBit_ variable from @ref APP_ERROR_t. If bit
...
typedef enum {
     ...
     */
    APP_ERROR_MANUFACTURER_START        = 0x30U,
    /** (@ref CO_CONFIG_EM_ERR_STATUS_BITS_COUNT - 1), largest value of the
     * Error status bit. */
    //APP_ERROR_MANUFACTURER_END          = CO_CONFIG_EM_ERR_STATUS_BITS_COUNT - 1
} APP_ERROR_errorStatusBits_t;
