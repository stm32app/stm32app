...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x7500_storageSDCard = {
        ...
        .SDIO_Index = 0x62A0,
        .FS_ReadSize = 0x00000010,
        .FS_ProgramSize = 0x00000010,
        .FS_BlockCycles = 500,
        .FS_CacheSize = 0x0010,
        .FS_LookaheadSize = 0x00000010,
...
typedef struct {
    ...
    OD_obj_record_t o_7500_storageSDCard[26];
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x7500, 0x1A, ODT_REC, &ODObjs.o_7500_storageSDCard, NULL},
