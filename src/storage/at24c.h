...
/* 0x74XX06: null */
#define storage_at24c_set_phase(at24c, value) actor_set_property_numeric(at24c->actor, STORAGE_AT24C_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define storage_at24c_get_phase(at24c) *((uint8_t *) actor_get_property_pointer(at24c->actor, STORAGE_AT24C_PHASE)
