...
/* 0x60XX08: null */
#define system_canopen_set_phase(canopen, value) actor_set_property_numeric(canopen->actor, SYSTEM_CANOPEN_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define system_canopen_get_phase(canopen) *((uint8_t *) actor_get_property_pointer(canopen->actor, SYSTEM_CANOPEN_PHASE)
/* 0x60XX09: Node ID */
#define system_canopen_set_node_id(canopen, value) actor_set_property_numeric(canopen->actor, SYSTEM_CANOPEN_NODE_ID, (uint32_t) (value), sizeof(uint8_t))
#define system_canopen_get_node_id(canopen) *((uint8_t *) actor_get_property_pointer(canopen->actor, SYSTEM_CANOPEN_NODE_ID)
/* 0x60XX0A: Negotiated bitrate */
#define system_canopen_set_bitrate(canopen, value) actor_set_property_numeric(canopen->actor, SYSTEM_CANOPEN_BITRATE, (uint32_t) (value), sizeof(uint16_t))
#define system_canopen_get_bitrate(canopen) *((uint16_t *) actor_get_property_pointer(canopen->actor, SYSTEM_CANOPEN_BITRATE)
