...
#define input_sensor_set_phase(sensor, value) actor_set_property_numeric(sensor->actor, INPUT_SENSOR_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define input_sensor_get_phase(sensor) *((uint8_t *) actor_get_property_pointer(sensor->actor, INPUT_SENSOR_PHASE)
