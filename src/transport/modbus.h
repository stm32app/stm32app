...
/* 0x62XX06: in us */
#define transport_modbus_set_phase(modbus, value) actor_set_property_numeric(modbus->actor, TRANSPORT_MODBUS_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define transport_modbus_get_phase(modbus) *((uint8_t *) actor_get_property_pointer(modbus->actor, TRANSPORT_MODBUS_PHASE)
