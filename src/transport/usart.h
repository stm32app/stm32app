...
/* 0x62XX0A: null */
#define transport_usart_set_phase(usart, value) actor_set_property_numeric(usart->actor, TRANSPORT_USART_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define transport_usart_get_phase(usart) *((uint8_t *) actor_get_property_pointer(usart->actor, TRANSPORT_USART_PHASE)
