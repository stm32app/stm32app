...
/* 0x62XX14: null */
#define transport_i2c_set_phase(i2c, value) actor_set_property_numeric(i2c->actor, TRANSPORT_I2C_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define transport_i2c_get_phase(i2c) *((uint8_t *) actor_get_property_pointer(i2c->actor, TRANSPORT_I2C_PHASE)
/* 0x62XX15: null */
#define transport_i2c_set_slave_address(i2c, value) actor_set_property_numeric(i2c->actor, TRANSPORT_I2C_SLAVE_ADDRESS, (uint32_t) (value), sizeof(uint8_t))
#define transport_i2c_get_slave_address(i2c) *((uint8_t *) actor_get_property_pointer(i2c->actor, TRANSPORT_I2C_SLAVE_ADDRESS)
