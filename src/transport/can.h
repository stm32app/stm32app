...
/* 0x62XX0B: null */
#define transport_can_set_phase(can, value) actor_set_property_numeric(can->actor, TRANSPORT_CAN_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define transport_can_get_phase(can) *((uint8_t *) actor_get_property_pointer(can->actor, TRANSPORT_CAN_PHASE)
