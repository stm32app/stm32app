...
/* 0x63XX06: null */
#define module_adc_set_phase(adc, value) actor_set_property_numeric(adc->actor, MODULE_ADC_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define module_adc_get_phase(adc) *((uint8_t *) actor_get_property_pointer(adc->actor, MODULE_ADC_PHASE)
