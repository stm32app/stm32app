...
/* 0x61XX05: null */
#define module_timer_set_phase(timer, value) actor_set_property_numeric(timer->actor, MODULE_TIMER_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define module_timer_get_phase(timer) *((uint8_t *) actor_get_property_pointer(timer->actor, MODULE_TIMER_PHASE)
