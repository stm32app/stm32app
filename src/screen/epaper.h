...
/* 0x90XX0D: null */
#define screen_epaper_set_phase(epaper, value) actor_set_property_numeric(epaper->actor, SCREEN_EPAPER_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define screen_epaper_get_phase(epaper) *((uint8_t *) actor_get_property_pointer(epaper->actor, SCREEN_EPAPER_PHASE)
