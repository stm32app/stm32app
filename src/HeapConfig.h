...
- 4: D3 internal 64kB ram   (0x38000000..0x3800FFFF)
  ...
  #define MALLOC_DMAREGION  4,  3,  2, -1, -1  // multi_malloc_dma, multi_calloc_dma, multi_realloc_dma, heapsize_dma : region 4 + region 3 + region 2
...
- 5: external 8MB sdram     (0xD0000000..0xD07FFFFF)
  ...
  #define MALLOC_DMAREGION  4,  3,  2, -1, -1, -1  // multi_malloc_dma, multi_calloc_dma, multi_realloc_dma, heapsize_dma : region 4 + region 3 + region 2
  #define MALLOC_INTREGION  0,  1,  4,  3,  2, -1  // multi_malloc_int, multi_calloc_int, multi_realloc_int, heapsize_int : region 0 + region 1 + region 4 + region 3 + region 2
  #define MALLOC_EXTREGION  5, -1, -1, -1, -1, -1  // multi_malloc_ext, multi_calloc_ext, multi_realloc_ext, heapsize_ext : region 5
*/
