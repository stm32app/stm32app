...
#define indicator_led_set_phase(led, value) actor_set_property_numeric(led->actor, INDICATOR_LED_PHASE, (uint32_t) (value), sizeof(uint8_t))
#define indicator_led_get_phase(led) *((uint8_t *) actor_get_property_pointer(led->actor, INDICATOR_LED_PHASE)
/* 0x98XX04: Brightness of LED between 0 and 255 */
#define indicator_led_set_duty_cycle(led, value) actor_set_property_numeric(led->actor, INDICATOR_LED_DUTY_CYCLE, (uint32_t) (value), sizeof(uint8_t))
#define indicator_led_get_duty_cycle(led) *((uint8_t *) actor_get_property_pointer(led->actor, INDICATOR_LED_DUTY_CYCLE)
