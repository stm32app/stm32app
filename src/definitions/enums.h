...
// defined in ./src/actor_file.h
char* get_actor_file_mode_name (uint32_t v);
// defined in ./src/actor_job.h
char* get_actor_job_signal_name (uint32_t v);
// defined in ./src/actor_thread.h
